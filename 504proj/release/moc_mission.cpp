...
struct qt_meta_stringdata_Mission_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Mission_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Mission_t qt_meta_stringdata_Mission = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Mission"
...
QT_INIT_METAOBJECT const QMetaObject Mission::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Mission.data,
    qt_meta_data_Mission,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Mission::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Mission.stringdata0))
