...
BattleFormLine::BattleFormLine(QObject *parent) : QObject(parent)
{

}

void BattleFormLine::exportForm(QTableWidget *tableWidget,QString dateDir,QString filename)
{
    ...
    QString title = QString("战斗报表");
    QString fileName = dateDir+QString("/")+QString(filename)+QString(".xls");
