...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Advance_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Advance_t qt_meta_stringdata_Advance = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Advance"
...
QT_INIT_METAOBJECT const QMetaObject Advance::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Advance.data,
    qt_meta_data_Advance,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Advance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Advance.stringdata0))
